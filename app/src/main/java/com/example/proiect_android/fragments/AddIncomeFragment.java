...
public class AddIncomeFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.add_income, container, false);
        datePicker = view.findViewById(R.id.button_select_date_income);
        textDate = view.findViewById(R.id.text_date_income);
