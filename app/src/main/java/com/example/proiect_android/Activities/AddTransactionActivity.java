...
//        setTitle("Add transaction");
    ...
    public void addTransactionButtonClicked(View view)
    {
        if(radioButtonExpenses.isChecked()) {
            ...
            textDate = findViewById(R.id.text_date_expense);
        }
        ...
        if(radioButtonIncome.isChecked()) {
            ...
            textDate = findViewById(R.id.text_date_income);
        }
    ...
    private void saveTransaction(){
        ...
        String transactionDate = textDate.getText().toString();
        String categoryId = "";
        if(radioButtonIncome.isChecked()){
            categoryId = "1";
        }else{
        ...
        if (description.trim().isEmpty() ||
                amount.trim().isEmpty() || transactionDate.trim().isEmpty() || transactionDate.trim().isEmpty()){
